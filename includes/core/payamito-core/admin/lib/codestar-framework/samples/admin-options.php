...
// Create options
//
KIANFR::createOptions( $prefix, [
	'menu_title' => 'KIANFR Demo',
	'menu_slug'  => 'kianfr-demo',
] );
...
KIANFR::createSection( $prefix, [
	...
	'fields'      => [
		...
		[
			...
			'default'  => '123456',
			'validate' => 'kianfr_validate_numeric',
		],
		...
		[
			...
			'validate' => 'kianfr_validate_required',
		],
